...
z = 0 #se declara una variable

while z < 20: #se crea un bucle x menor que 10
	z += 1 #se va incrementendo el valor 1 por 1 
	if z == 2 or z == 9: #se crea un condicional si x es igual a 5 o 7 se cumple 
		continue #se usa el metodo continue para hacer el salto de los valores 5 y 7 
	print(z) #se imprime la varible x 
