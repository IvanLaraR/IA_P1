#la fucnion range empieza a contar desde el 0 y acomoda cada elemento en un renglon

for x in range(10):#se crea un bucle y se declara una variable en el range para acomomdar los elementos que esten dentro de este
